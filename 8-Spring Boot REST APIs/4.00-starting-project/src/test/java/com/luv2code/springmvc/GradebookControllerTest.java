...
public class GradebookControllerTest {
    ...
    public static void setup() {
        ...
        request.setParameter("firstname", "Nafise");
        request.setParameter("lastname", "Mouga");
        request.setParameter("emailAddress", "nafise@gmail.com");
    }

    @Test
    public void getStudentsHttpRequest() throws Exception {

        student.setFirstname("Nafise");
        student.setLastname("Mouga");
        student.setEmailAddress("nafise@gmail.com");
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("nafise@gmail.com");
